        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        Subject = "Password Reset for Budget Destroyer",
                        Body = string.Format(message, "Budget Destroyer Admin", "noreply@gmail.com", "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>"),
                        IsBodyHtml = true
                    };
